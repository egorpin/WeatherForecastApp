...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_FileDownloader_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_FileDownloader_t qt_meta_stringdata_FileDownloader = {
    {
...
Q_CONSTINIT static const uint qt_meta_data_FileDownloader[] = {
...
Q_CONSTINIT const QMetaObject FileDownloader::staticMetaObject = { {
    ...
    qt_meta_stringdata_FileDownloader.offsetsAndSizes,
...
void FileDownloader::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->downloaded((*reinterpret_cast< std::add_pointer_t<QByteArray>>(_a[1]))); break;
        case 1: _t->fileDownloaded((*reinterpret_cast< std::add_pointer_t<QNetworkReply*>>(_a[1]))); break;
        default: ;
        }
        ...
        {
            using _t = void (FileDownloader::*)(QByteArray );
            if (_t _q_method = &FileDownloader::downloaded; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void FileDownloader::downloaded(QByteArray _t1)
{
